...
echo '<span> ', EOL;
echo '<a href="https://twitter.com/'.$_settings['twitter'].'"><i class="fa fa-twitter"></i></a>', EOL;
echo '<a href="https://github.com/'.$_settings['github'].'"><i class="fa fa-github"></i></a>', EOL;
...
echo '<span>'.$_settings['copy_right'].' © '.date("Y").'</span>', EOL;
echo '</div>', EOL;
echo '</div>', EOL;
echo '</div>', EOL;
echo '</footer>', EOL;
